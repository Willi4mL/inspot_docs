...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Dokomentation","description":"Inspot dokmentations sida","base":"/inspot_docs/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"light":"/images/logotype/inspot_dark.png","dark":"/images/logotype/inspot_white.png"},"search":{"provider":"local","options":{}},"nav":[{"text":"Hem","link":"/"},{"text":"Om Inspot dokumentation","link":"/docs-landing"},{"text":"Vitepress guide","link":"https://vitepress.dev/guide/what-is-vitepress","target":"_blank"}],"sidebar":[{"text":"Kategorier","items":[{"text":"ACF blocks","collapsed":true,"items":[{"text":"Test","link":"/"}]},{"text":"Funktioner","collapsed":true,"items":[{"text":"Wordpress","collapsed":true,"items":[{"text":"Tillåt SVG","link":"/docs-pages/docs-functions/enable-svg"},{"text":"Brödsmulor","link":"/docs-pages/docs-functions/breadcrumbs"},{"text":"Wordpress 1","link":"/"}]},{"text":"PHP","collapsed":true,"items":[{"text":"Fixa teckenkodning","link":"/docs-pages/docs-functions/teckenkodning-för-svenska-tecken"}]},{"text":"Javascript","collapsed":true,"items":[{"text":"Cookie","link":"/docs-pages/docs-functions/cookie-js"}]}]},{"text":"Element","collapsed":true,"items":[{"text":"Knappar","link":"/docs-pages/docs-elements/buttons"},{"text":"Popup","link":"/docs-pages/docs-elements/popup"},{"text":"Element 2","link":"/"}]},{"text":"Verktyg","collapsed":true,"items":[{"text":"Färger","link":"/docs-pages/docs-tools/colors"},{"text":"Bilder","link":"/docs-pages/docs-tools/resolution"}]},{"text":"Markdown Examples","link":"/markdown-examples"},{"text":"Runtime API Examples","link":"/api-examples"},{"text":"Om inspot dokumenation","link":"/docs-landing"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/Willi4mL/inspot_docs"}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
var define_import_meta_env_default = { BASE_URL: "/inspot_docs/", MODE: "production", DEV: false, PROD: true, SSR: true };
